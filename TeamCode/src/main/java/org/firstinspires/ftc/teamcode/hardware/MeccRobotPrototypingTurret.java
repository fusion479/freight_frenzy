...
@Config
public class MeccRobotPrototypingTurret extends Mechanism{
    ...
    private SCORINGFSMTurretMode scoring = new SCORINGFSMTurretMode();
//
//    private SenseHub senseHub = new SenseHub();
    ...
    BooleanManager dpadRight2 = new BooleanManager(new Runnable() {
        @Override
        public void run() {
            scoring.setRightDefault();
        }
    });

    BooleanManager dpadTop2 = new BooleanManager(new Runnable() {
        @Override
        public void run() {
            scoring.setMiddleDefault();
        }
    });
...
//    }
    ...
    public void turret(Gamepad gamepad){
        ...
        dpadTop2.update(gamepad.dpad_up);
    }
